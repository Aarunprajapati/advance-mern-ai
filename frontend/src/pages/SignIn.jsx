...
const SignIn = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    await axiosInstance.post(APIS.login, user);
  };
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            <input
              ...
              className="border border-blue-300 outline-none shadow-blue-300 transition-all shadow-sm p-4 text-white rounded-lg bg-transparent"
            />
            ...
            <button
              type="submit"
              className="text-white px-4 py-2 mt-4 my-2 border border-blue-500 shadow-2xl bg-gradient-to-r from-pink-600 to-blue-600 w-24 rounded-xl cursor-pointer transition transform active:scale-95 active:shadow-inner "
            >
              SignIn
            </button>
